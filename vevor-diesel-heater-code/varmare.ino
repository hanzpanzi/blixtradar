 ...
 *
 * Webb:   http://varmare.local/  eller http://<ip>:8081/  lösenord: VALJT-LOSENORD-WEB
 * Moln:   https://hanzpanzi.github.io/blixtradar/varmare/cloud.html
 * OTA:    http://<ip>/update  (lösenord: VALJT-LOSENORD-OTA)
 *
...
const char* WEB_PASSWORD  = "VALJT-LOSENORD-WEB";         // lösenord till webbsidan
const char* OTA_PASSWORD  = "VALJT-LOSENORD-OTA";          // lösenord för /update
...
const char* MQTT_TOPIC    = "ditt-namn/heater";
...
bool authOk() {
  ...
  if (web->hasHeader("Authorization")) {
    ...
    // Basic dXNlcjpwZXJrZWwx (user:VALJT-LOSENORD-WEB)
